...
public class MovieListController implements Initializable, Observer {
    ...
    protected ISortedState sortedState;
    ...
    public void sortMovies() {
        sortedState.sortMovies(observableMovies);
        sortedState = sortedState.nextState();
    }
    ...
    public void update(boolean success) {
        if (success) {
            javafx.application.Platform.runLater(() -> {
                UserDialog dialog = new UserDialog("Watchlist", "Movie successfully added to watchlist");
                dialog.show();
            });
        } else {
        javafx.application.Platform.runLater(() -> {
            UserDialog dialog = new UserDialog("Watchlist", "Movie already on watchlist");
            dialog.show();
